...
export const standorteDetail: Record<string, StandortDetail> = {
  ...
  muelheim: {
    ...
    heroIntro:
      'Sie planen eine Sanierung in Mülheim an der Ruhr und vermuten Asbest oder andere Schadstoffe im Gebäude? Asbesta ist Ihr zertifizierter Fachbetrieb für Schadstoffsanierung nach TRGS 519, 521 und 524. Wir sitzen in Marl und sind im gesamten Ruhrgebiet unterwegs, auch entlang der Ruhr in Mülheim.',
    anfahrt:
  ...
  marl: {
    ...
    metaDescription:
      'Asbest- & Schadstoffsanierung in Marl direkt von unserem Firmensitz. Zertifiziert nach TRGS 519, 15+ Jahre Erfahrung.',
    heroIntro:
  ...
  herten: {
    ...
    localFaqs: [
      ...
      },
      {
        ...
        antwort:
          'Ja. Asbesta ist ein zugelassener Fachbetrieb nach TRGS 519 und arbeitet zudem nach TRGS 521 und 524 sowie nach den Vorgaben der GefStoffV. In über 15 Jahren haben wir mehr als 1.000 Projekte abgewickelt - sicher, dokumentiert und mit abschließender Freimessung nach VDI 3492.',
      },
      {
        frage:
