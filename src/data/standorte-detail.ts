  ...
  gelsenkirchen: {
    ...
    localFaqs: [
      ...
      },
      {
        ...
        antwort:
          'In geschützten Siedlungen wie Flöz Dickebank oder Schüngelberg muss die Sanierung mit dem Denkmalschutz abgestimmt werden. Wir planen den Schadstoffrückbau so, dass die historische Substanz erhalten bleibt, und entfernen Asbest nach TRGS 519 sowie künstliche Mineralfasern (KMF) nach TRGS 521 gezielt und staubdicht.',
      },
      {
